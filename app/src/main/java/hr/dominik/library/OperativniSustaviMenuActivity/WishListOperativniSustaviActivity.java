package hr.dominik.library.OperativniSustaviMenuActivity;
...
public class WishListOperativniSustaviActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wish_list_operativni_sustavi);
    ...
    private void setupFavoritesListView(){
        ...
        try {
            ...
            Cursor cursor = database.query(HardverDatabaseHelper.TABLE_NAME,
                    ...
                    "favorite = 1",
                    null,null,null,null);
            CursorAdapter favoriteAdapter = new SimpleCursorAdapter(WishListOperativniSustaviActivity.this,
